// dragdrop.js — Drag & drop: hand reorder, fondo→hand, hand→fondo, hand→bajada
'use strict';

const DragDrop = (() => {
  let dragId = null;
  let dragSource = null; // 'hand' | 'fondo'
  let ghost = null;
  ...
  function _endHandDrag(pt, cid, cbs) {
    // 1. Dropped on bajada pile → acomodar
